...
def runstrategy(contracts, strategy, **kwargs):
    args = parse_args()
    ...
    storekwargs = dict(
        ...
        timeoffset=not kwargs["no_timeoffset"],
        reconnect=kwargs["reconnect"],
        timeout=kwargs["timeout"],
        notifyall=kwargs["notifyall"],
        _debug=kwargs["debug"],
    )
    ...
    print(args.data0)
    data0 = ibstore.getdata(dataname=args.data0, **datakwargs)
    ...
    if args.data1 is not None:
        if args.data1 != args.data0:
            ...
            data1 = ibstore.getdata(dataname=args.data1, **datakwargs)
        else:
            data1 = data0
